 ...
 */
 function typewrite()
 {
     let str="<很幸运可以遇见你，这个礼物我想送给你，哪怕......是很少一点点的浪漫<因为当代码不止是代码的时候，它就有了新的意义。<";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     {name:"A",yin:8, str:"<br><br><br>故事还在继续，我们却越走越远。<br><br>还有....,其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
 ...
 function fl(e)
 {
     ...
     if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
     {
         ...
         if(s.indexOf("LJWYYKX")!=-1&&records==0)
         {
             setTimeout(function()
             {
                 records=1;
